...
public class AddWalletActivityV2 implements RequestHandler<AddWalletRequest, AddWalletResult>  {
    ...
    @Inject
    public AddWalletActivityV2(UsersDao usersDao, WalletDao walletDao, CryptoDao cryptoDao) {
