...
public class AddWalletResult {
    ...
    public AddWalletResult() {

    }

    public AddWalletResult(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        AddWalletResult that = (AddWalletResult) o;
    ...
    public static final class Builder {
        ...
        public AddWalletResult build() {
            return new AddWalletResult(this);
        }
    }
}
