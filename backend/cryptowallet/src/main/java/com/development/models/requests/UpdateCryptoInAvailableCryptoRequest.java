...
public class UpdateCryptoInAvailableCryptoRequest {
    ...
    public UpdateCryptoInAvailableCryptoRequest() {

    }


    public UpdateCryptoInAvailableCryptoRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateCryptoInAvailableCryptoRequest that = (UpdateCryptoInAvailableCryptoRequest) o;
    ...
    public String toString() {
        return "UpdateCryptoInAvailableCryptoRequest{" +
                "token='" + token + '\'' +
    ...
    public static final class Builder {
        ...
        public UpdateCryptoInAvailableCryptoRequest build() {
            return new UpdateCryptoInAvailableCryptoRequest(this);
        }
    }
}
