...
public class UpdateCryptoInWalletRequest {
    ...
    public UpdateCryptoInWalletRequest() {

    }


    public UpdateCryptoInWalletRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateCryptoInWalletRequest that = (UpdateCryptoInWalletRequest) o;
    ...
    public String toString() {
        return "UpdateCryptoInWalletRequest{" +
                "token='" + token + '\'' +
                ", userId='" + userId + '\'' +
    ...
    public static final class Builder {
        ...
        public UpdateCryptoInWalletRequest build() {
            return new UpdateCryptoInWalletRequest(this);
        }
    }
}
