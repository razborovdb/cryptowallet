...
public class DeleteCryptoInAvailableCryptoRequest {
    ...
    public DeleteCryptoInAvailableCryptoRequest() {

    }


    public DeleteCryptoInAvailableCryptoRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteCryptoInAvailableCryptoRequest that = (DeleteCryptoInAvailableCryptoRequest) o;
    ...
    public String toString() {
        return "DeleteCryptoInAvailableCryptoRequest{" +
                "token='" + token + '\'' +
    ...
    public static final class Builder {
        ...
        public DeleteCryptoInAvailableCryptoRequest build() {
            return new DeleteCryptoInAvailableCryptoRequest(this);
        }
    }
}
