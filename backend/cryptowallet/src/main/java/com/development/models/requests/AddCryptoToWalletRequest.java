...
public class AddCryptoToWalletRequest {
    ...
    public AddCryptoToWalletRequest() {

    }


    public AddCryptoToWalletRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        AddCryptoToWalletRequest that = (AddCryptoToWalletRequest) o;
    ...
    public String toString() {
        return "AddCryptoToWalletRequest{" +
                "token='" + token + '\'' +
                ", userId='" + userId + '\'' +
    ...
    public static final class Builder {
        ...
        public AddCryptoToWalletRequest build() {
            return new AddCryptoToWalletRequest(this);
        }
    }
}
