...
public class GetCryptoFromAvailableCryptoResult {
    ...
    public GetCryptoFromAvailableCryptoResult() {

    }


    public GetCryptoFromAvailableCryptoResult(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        GetCryptoFromAvailableCryptoResult that = (GetCryptoFromAvailableCryptoResult) o;
    ...
    public static final class Builder {
        ...
        public GetCryptoFromAvailableCryptoResult build() {
            return new GetCryptoFromAvailableCryptoResult(this);
        }
    }
}
