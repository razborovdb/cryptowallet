...
public class GetUserOneWalletRequest {
    ...
    public GetUserOneWalletRequest() {

    }

    public GetUserOneWalletRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        GetUserOneWalletRequest that = (GetUserOneWalletRequest) o;
    ...
    public String toString() {
        return "GetUserOneWalletRequest{" +
                "token='" + token + '\'' +
                ", email='" + email + '\'' +
    ...
    public static final class Builder {
        ...
        public GetUserOneWalletRequest build() {
            return new GetUserOneWalletRequest(this);
        }
    }
}
