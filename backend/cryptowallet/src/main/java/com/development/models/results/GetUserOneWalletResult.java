...
public class GetUserOneWalletResult {
    ...
    public GetUserOneWalletResult() {

    }

    public GetUserOneWalletResult(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        GetUserOneWalletResult that = (GetUserOneWalletResult) o;
    ...
    public static final class Builder {
        ...
        public GetUserOneWalletResult build() {
            return new GetUserOneWalletResult(this);
        }
    }
}
