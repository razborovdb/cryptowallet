...
public class AddCryptoToWalletResult {
    ...
    public AddCryptoToWalletResult() {

    }

    public AddCryptoToWalletResult(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        AddCryptoToWalletResult that = (AddCryptoToWalletResult) o;
    ...
    public String toString() {
        return "AddCryptoToWalletResult{" +
                "userId='" + userId + '\'' +
    ...
    public static final class Builder {
        ...
        public AddCryptoToWalletResult build() {
            return new AddCryptoToWalletResult(this);
        }
    }
}
