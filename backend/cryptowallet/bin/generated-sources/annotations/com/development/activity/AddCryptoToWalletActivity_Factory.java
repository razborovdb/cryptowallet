...
public final class AddCryptoToWalletActivity_Factory implements Factory<AddCryptoToWalletActivity> {
  ...
  public AddCryptoToWalletActivity_Factory(Provider<UsersDao> usersDaoProvider,
  ...
  public static AddCryptoToWalletActivity_Factory create(Provider<UsersDao> usersDaoProvider,
      Provider<WalletDao> walletDaoProvider, Provider<CryptoDao> cryptoDaoProvider) {
    return new AddCryptoToWalletActivity_Factory(usersDaoProvider, walletDaoProvider, cryptoDaoProvider);
  }

  public static AddCryptoToWalletActivity newInstance(UsersDao usersDao, WalletDao walletDao,
      CryptoDao cryptoDao) {
