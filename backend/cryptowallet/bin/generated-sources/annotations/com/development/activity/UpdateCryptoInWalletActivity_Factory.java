...
public final class UpdateCryptoInWalletActivity_Factory
    implements Factory<UpdateCryptoInWalletActivity> {
  ...
  public UpdateCryptoInWalletActivity_Factory(
  ...
  public UpdateCryptoInWalletActivity get() {
    return new UpdateCryptoInWalletActivity(
        usersDaoProvider.get(), walletDaoProvider.get(), cryptoDaoProvider.get());
  }

  public static UpdateCryptoInWalletActivity_Factory create(
      Provider<UsersDao> usersDaoProvider,
      Provider<WalletDao> walletDaoProvider,
      Provider<CryptoDao> cryptoDaoProvider) {
    return new UpdateCryptoInWalletActivity_Factory(
